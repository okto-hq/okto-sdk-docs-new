---
title: React Setup
description: In this guide, you'll learn how to create a React app and initialize it with the Okto SDK. This includes setting up authentication using Google OAuth and the Okto Provider.
full: false
---
...
1. **Traditional Create React App setup with manual configuration:**  
  This method is best for developers who need full control and customization over their project.
2. **Streamlined Okto React setup:**  
  This is the easiest way to get started with a pre-configured setup.
3. **Streamlined Okto Next.js-based setup:**  
  This method is ideal for Next.js developers looking to leverage Okto with minimal configuration.
...
<Step>
    ...
    🎉 Congratulations! You have successfully built a basic dApp powered by Okto.You can now focus on implementing your business logic and optimizing the UI/UX. You can checkout how to use other features in the [Template Repo](https://github.com/okto-hq/okto-sdk-react-template-app/).
</Step>
...
<Step>
    ...
    Make sure to replace the placeholder values with your actual Google Client ID and Okto API Key. For instructions on getting Google credentials, follow our [Google OAuth2 Setup Guide](https://docs.okto.tech/docs/react-sdk/advanced-sdk-config/authenticate-users/google-oauth/google-console-setup). 
</Step>
