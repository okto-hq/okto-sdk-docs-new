...
<Callout title="Note">
- For **Sandbox**, follow the steps below to set up sponsorship via the Okto Dashboard.  
- For **Production**, vendors must manually configure the paymaster. Refer to the <a href="/paymaster-setup-doc.pdf" target="_blank" rel="noopener noreferrer">Paymaster Setup Guide</a> for detailed instructions.  
</Callout>
